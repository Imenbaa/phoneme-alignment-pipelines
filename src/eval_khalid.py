    ...
    with open(args.csv_path, "w", newline="", encoding="utf-8") as f:
        ...
        for tg,wav in tg_to_wav.items():
            ...
            if os.path.exists(wav_file) and os.path.exists(trans_file) and tg !="CCM-004773-01_L01.TextGrid" and wav !="CCM-004773-01_L01.wav":
                ...
                writer.writerow({"trans_w2vec_vad_chunk": normalization(pred_transcriptions_w2v2_chunk)})
                ...
                writer.writerow({"trans_whisper_vad_chunk": normalization(pred_transcriptions_whisper_med_chunk)})
                ...
                writer.writerow({"trans_whisper_large_vad_chunk": normalization(pred_transcriptions_whisper_large_chunk)})
                ...
                writer.writerow({"trans_conf_cv_vad_chunk": normalization(pred_transcriptions_conf_cv)})
                ...
                writer.writerow({"trans_conf_ester_vad_chunk": normalization(pred_transcriptions_conf_ester)})
                ...
                writer.writerow({"trans_hmm_tdnn_vad_chunk": normalization(pred_transcriptions_hmm_tdnn)})
