...
def get_loss_weights(global_step: int,
    ...
    return 3.0, 0.5 * w_fs, 0.5 * w_m  # λ_ctc: 1.0 → 3.0
...
# No checkpoint loading — start fresh from pretrained CTC
# =========================
# Step 10: Trainer
# =========================
...
class FSCTCTrainer(Trainer):
    ...
    def create_optimizer(self):
        self.optimizer = torch.optim.AdamW([
            {"params": list(self.model.wav2vec2.parameters()), "lr": 5e-7},  # was 5e-6
{"params": self.model.ctc_head.parameters(),       "lr": 5e-7},,
{"params": list(self.model.fx.parameters()) +
           list(self.model.fy.parameters()) +
           list(self.model.phoneme_embed.parameters()), "lr": 1e-4},
{"params": self.model.reconstruction_head.parameters(), "lr": 1e-4},
{"params": self.model.quantizer.weight_proj.parameters(), "lr": 1e-3},
